...
The first week of every program, during which Interns receive training on specific technologies that are relevant to their Assigned Issue. You can view the Onboarding Week assignments that your Interns were given in your [CodeDay Labs Mentor Dashboard](./dashboard.md) .
